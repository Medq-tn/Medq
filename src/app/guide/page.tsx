...
export const metadata = {
  title: "Guide d'utilisation | MedQ",
  description: "Découvrez comment tirer le meilleur parti de MedQ: inscription, QCM, révisions, statistiques et plus.",
};
      ...
      <section className="py-12 md:py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-5 shadow-sm mb-8">
            ...
            <div className="mt-3 grid sm:grid-cols-2 gap-2 text-sm">
              {[
                ...
                <Link key={i.href} href={i.href} className="text-medblue-700 hover:text-medblue-800 underline">
                  {i.label}
                </Link>
              ))}
            </div>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p>Consultez la <Link href="/faq" className="text-medblue-700 underline">FAQ</Link> ou contactez‑nous : 
              <a href="mailto:contact@medq.tn" className="text-medblue-700 underline ml-1">contact@medq.tn</a>.
            </p>
          </div>
        </div>
      </section>
...
// (No local UI components needed; page uses clean textual layout)
