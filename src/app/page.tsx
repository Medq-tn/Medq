  ...
  useEffect(() => {
    if (!isLoading && user) {
      if (user.role === 'admin') {
        ...
        // Non-admin users go to coming soon page
      ...
      <nav className={`fixed w-full top-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-14 md:h-16">
            ...
            {/* Desktop CTAs */}
            <div className="hidden lg:flex space-x-3 md:space-x-4">
              <Button 
                variant="outline" 
            ...
            <div className="px-4 py-3 divide-y divide-gray-100">
              ...
              <div className="flex flex-col gap-2 py-3">
                <Button
                  ...
                  className="w-full border-medblue-600 text-medblue-700 hover:bg-medblue-50"
                >
                  Pré‑inscription
                </Button>
                <Button
