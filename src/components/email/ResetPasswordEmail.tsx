              ...
              <td style={{ padding: '24px 16px' }}>
                <table role="presentation" width="100%" style={{ maxWidth: 640, margin: '0 auto', background: '#ffffff', borderRadius: 16, boxShadow: '0 10px 25px rgba(2,6,23,0.07)', overflow: 'hidden' }}>
                  <tbody>
                    ...
                    <tr>
                      <td style={{ padding: 24 }}>
                        <h1 style={{ margin: '0 0 8px', fontSize: 24, lineHeight: '28px', color: '#0f172a' }}>Réinitialiser votre mot de passe</h1>
                        <p style={{ margin: '0 0 16px', fontSize: 16, color: '#334155' }}>Bonjour {name},</p>
                        <p style={{ margin: '0 0 16px', fontSize: 16, color: '#334155' }}>
                          Nous avons reçu une demande de réinitialisation du mot de passe de votre compte MedQ. Cliquez sur le bouton ci‑dessous pour définir un nouveau mot de passe.
                        </p>

                        <p style={{ textAlign: 'center', margin: '24px 0' }}>
                          <a href={resetUrl} style={{ background: '#2563eb', color: '#ffffff', textDecoration: 'none', padding: '12px 24px', borderRadius: 9999, display: 'inline-block', fontWeight: 600 }}>
                            Réinitialiser mon mot de passe
                          </a>
                        </p>

                        <p style={{ margin: '0 0 8px', fontSize: 14, color: '#475569' }}>Si le bouton ne fonctionne pas, copiez et collez ce lien dans votre navigateur&nbsp;:</p>
                        <p style={{ margin: 0, fontSize: 12, color: '#334155', wordBreak: 'break-all' }}>{resetUrl}</p>

                        <hr style={{ border: 0, borderTop: '1px solid #e2e8f0', margin: '24px 0' }} />
                        <p style={{ margin: 0, fontSize: 12, color: '#64748b' }}>Ce lien expire dans 1&nbsp;heure. Si vous n’êtes pas à l’origine de cette demande, ignorez simplement cet e‑mail.</p>
                      </td>
                    </tr>
                    <tr>
