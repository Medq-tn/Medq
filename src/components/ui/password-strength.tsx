  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between text-sm">
        <span>{t('auth.passwordStrengthLabel', 'Solidité du mot de passe')}:</span>
        <span className={`font-medium ${getPasswordStrengthColor(validation.strength)}`}>
          {t(`auth.passwordStrength.${validation.strength}`, getPasswordStrengthText(validation.strength))}
        </span>
      </div>
